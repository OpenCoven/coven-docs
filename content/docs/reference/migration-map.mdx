...
Old slugs that were replaced on this site, kept here so external links and history stay traceable.

<DocsDataTable
  caption="Renamed docs site slugs"
  searchPlaceholder="Filter renamed slugs..."
  columns={[
    { key: 'old', label: 'Old slug' },
    { key: 'new', label: 'New slug' },
    { key: 'note', label: 'Note' },
  ]}
  rows={[
    { old: '`/docs/reference/research-coven-github-agent`', new: '[/docs/reference/coven-github-agent](/docs/reference/coven-github-agent)', note: 'The research abstract became a current-state page once coven-github and coven-github-webhook shipped.' },
  ]}
/>
