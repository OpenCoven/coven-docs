...
- **OpenClaw integrations** are orchestration surfaces that can hand work into the same local runtime without hiding what happened.
...
- Keep OpenClaw copy honest: orchestration sits above Coven; it does not replace the runtime substrate.
...
- [ ] OpenClaw intake creates or requests a Coven task
...
- Separate **Coven runtime**, **comux cockpit**, and **OpenClaw intake** so people understand the architecture.
