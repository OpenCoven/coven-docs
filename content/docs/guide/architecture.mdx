...
description: "How the Coven Rust daemon, CLI, TUI, CastCodes, Cast Agent, and OpenClaw plugin compose around the local socket API, PTY adapters, and event store."
