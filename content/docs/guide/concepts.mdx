...
OpenCoven is the ecosystem and organization around the Coven runtime, the cockpit, and integrations.
...
- **`owning adapter`** — Identifies the daemon or adapter responsible for the capability.
