---
title: "CLI Reference"
summary: "The command map for Coven's local CLI: help, setup, sessions, observability, hub and scheduling, engine and auth, and repo workflow."
...
read_when:
  ...
  - You need to discover a command or produce a machine-readable command catalog
  - You are deciding whether to use setup, the TUI, daemon, run, sessions, or repair flows
---
...
Use [Provider setup](/docs/cli/setup) for consent, verification, and report semantics.
...
- [Provider setup](/docs/cli/setup) for consent-gated login and bounded verification.
