...
Run it bare — no subcommand — for the default full report (health summary, top processes, disk usage) in compact form:
...
| Command | Use it for |
| --- | --- |
| `coven pc` | Full compact report (no subcommand). |
