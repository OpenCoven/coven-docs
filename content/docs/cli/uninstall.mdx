...
No output means the command is gone. If a path or command record still prints, another install is still present — remove it with the matching method above.
