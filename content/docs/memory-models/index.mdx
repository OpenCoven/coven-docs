...
Memory gives durable context to work that spans sessions. Coven records sessions and events; local clients can derive memory from those records; harnesses keep provider authentication and model access. Coven does not become a model gateway.
